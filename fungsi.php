<?php 
    ...
    function tambah_data ($data, $files){
        ...
        $query = "INSERT INTO tb_siswa VALUES(null, '$nim', '$nama_mahasiswa', '$jenis_kelamin', '$foto', '$alamat')";
    ...
    function ubah_data ($data, $files){
        ...
        $query =" UPDATE tb_siswa SET nim='$nim', nama_mahasiswa='$nama_mahasiswa', jenis_kelamin='$jenis_kelamin', alamat='$alamat', foto_siswa = '$foto' WHERE id_siswa ='$id_siswa';";
        $sql = mysqli_query($GLOBALS['conn'], $query);
